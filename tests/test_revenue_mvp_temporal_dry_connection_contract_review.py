...
class DryConnectionContractReviewTests(unittest.TestCase):
    def test_public_validated_state_handoff_is_required(self):
        ...
        self.assertFalse(result.public_validated_state_bundle_available)
    ...
    def test_unexpected_public_handoff_fails_closed_pending_review(self):
