(() => {
  ...
  function createControls() {
    ...
    panel.innerHTML = '<p>サイト改善のため、同意いただいた場合に限りGoogle Analyticsを使用します。広告用の保存領域とシグナルは使用しません。詳しくは<a href="/privacy">プライバシーポリシー</a>をご確認ください。</p><div class="analytics-consent__actions"><button type="button" class="analytics-consent__accept">アクセス解析を許可</button><button type="button" class="analytics-consent__deny">拒否して続ける</button></div>';
