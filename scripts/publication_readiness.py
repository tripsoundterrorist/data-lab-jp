...
REASON_ORDER = (
    ...
    "LIFECYCLE_CONDITIONS_NOT_VERIFIED",
    "SORT_SEMANTICS_CONDITIONS_NOT_VERIFIED",
...
def build_report(value: Any, *, generated_at: datetime) -> PublicationReadinessReport:
    try:
        ...
        if gates["LIFECYCLE_GATE"] != PASS:
            reasons.add("LIFECYCLE_CONDITIONS_NOT_VERIFIED")
        if gates["SEMANTICS_GATE"] != PASS:
            reasons.add("SORT_SEMANTICS_CONDITIONS_NOT_VERIFIED")
        ...
        blocker_actions = {
            "DMM_LIFECYCLE_AVAILABILITY": "IMPLEMENT_DMM_LIFECYCLE_CONDITIONS",
            "DMM_SORT_SEMANTICS": "IMPLEMENT_DMM_SORT_SEMANTICS_CONDITIONS",
