...
FAST_TEST_FILES = (
    "test_development_automation_activation_preflight.py",
    "test_development_automation_activation_review_packet.py",
    "test_development_automation_activation_review_request.py",
